      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold">TestimonyShot</h3>
                  <p className="text-gray-400 text-sm">Turn Feedback Into Flex</p>
                </div>
              </div>
              <p className="text-gray-400 mb-6 max-w-md">
                Create stunning testimonial graphics from customer feedback in seconds. Perfect for social media, websites, and marketing materials.
              </p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2025 TestimonyShot. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
